...
libs/
  ...
  planning        — RFC 5545 recurring events, RSVP, per-occurrence exceptions, event reminder scheduler
...
| Planning      | [`@libs/planning`](libs/planning/README.md)           | RFC 5545 recurring events, RSVP, per-occurrence exceptions, calendar range queries, event reminder notifications (cron sweep every 5 min) |
